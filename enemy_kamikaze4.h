class CEnemyKamikaze4:public CEnemy{
	double m_tx,m_ty;
	int mStopY;
	public:
	void UpdateEnemy();
	void Killed();
	void CreateEnemy() { mAutoDelFlg = false; m_vy = 3; m_tx = m_ty = 0; mStopY = rand() % 200 + 100; }
};

void CEnemyKamikaze4::UpdateEnemy(){
	static const int startTimeInterval=20;
