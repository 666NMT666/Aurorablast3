class CEnemyDragonfly1:public CEnemy{
	int mTargetY;
public:
	void UpdateEnemy();
	void CreateEnemy();
...
void CEnemyDragonfly1::CreateEnemy(){
...
void CEnemyDragonfly1::UpdateEnemy(){
	mBltInfo.type=BLT_KEY;
	drawFlap(m_bg,&mPartsImg[COMMON_WING_RIGHT],m_x+m_width/2-20,m_y-50,0,0,500,70*sin(N_PI*mTimer*49),0);
	drawFlap(m_bg,&mPartsImg[COMMON_WING_LEFT],m_x-m_width/2+20,m_y-50,0,0,500, 70*sin(N_PI*mTimer*49),1);

	drawFlap(m_bg,&mPartsImg[COMMON_WING_RIGHT],m_x+m_width/2-20,m_y-90,0,0,500,70*cos(N_PI*mTimer*49),0);
	drawFlap(m_bg,&mPartsImg[COMMON_WING_LEFT],m_x-m_width/2+20,m_y-90,0,0,500, 70*cos(N_PI*mTimer*49),1);
